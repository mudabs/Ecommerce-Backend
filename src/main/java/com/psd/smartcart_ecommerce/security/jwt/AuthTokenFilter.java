...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    private String parseJwt(HttpServletRequest request) {
        // Primary: accept Bearer token from Authorization header.
        // This prevents stale cookies from overriding a fresh token sent by the frontend.
